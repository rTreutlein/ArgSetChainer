...
class MettalogHandler:                                                          
    def __init__(self):
        ...
        path = os.path.join(relative_path, 'main')
...
if __name__ == '__main__':
    ...
    print(handler.add_atom("(: fact1 (A a1) (STV 1.0 1.0))"))
    print(handler.add_atom("(: rule1 (Implication (A $a) (B $b)) (STV 1.0 1.0))"))

    print(handler.query("(: $query (B $a) $ntv)"))
